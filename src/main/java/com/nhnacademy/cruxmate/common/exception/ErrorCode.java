...
public enum ErrorCode {
    ...
    LOGIN_FAILED(HttpStatus.UNAUTHORIZED, "AUTH001", "이메일 또는 비밀번호가 올바르지 않습니다."),
    AUTHENTICATION_REQUIRED(HttpStatus.UNAUTHORIZED, "AUTH002", "인증이 필요합니다."),
    ACCESS_DENIED(HttpStatus.FORBIDDEN, "AUTH003", "요청을 수행할 권한이 없습니다.");
